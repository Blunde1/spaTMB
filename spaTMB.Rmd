...
From --cite variance components page 457-- we have, for an individual element $\nu_j$
...
$$
This can also be solved purely by using AD, see Table 1 in -cite Skaug Fournier 2006-.
...
The R code for the "fix" is provided.
